...
const creators = [
  ...
  },
  {
    ...
    isLive: true,
    streamUrl: 'https://player.twitch.tv/?channel=fps_shaka&parent=localhost',
    streamDescription: 'ランクマッチ配信！今日は最高ランク目指して頑張ります💪\n\n使用キャラ：アタッカー中心\n目標：プラチナランク到達\n\nチャットで応援よろしくお願いします！',
    packCount: 2,
    totalSales: 180000,
    followerCount: 12500,
    sparksConsumed: {
  ...
  },
  {
    ...
    streamDescription: '今夜の試合を解説します！⚽\n\n注目ポイント：\n・両チームの戦術分析\n・key playerの動き\n・試合の流れを読む\n\nサッカー好きな方、ぜひチャットで一緒に盛り上がりましょう！',
    packCount: 3,
    totalSales: 280000,
    followerCount: 19700,
    sparksConsumed: {
  ...
  },
  {
    ...
    streamDescription: 'お絵描き配信🎨\n\n今日のテーマ：キャラクターの表情の描き方\n\n【内容】\n・喜怒哀楽の表現方法\n・目と口の描き分け\n・感情を伝える小技\n\n初心者の方も一緒に描いてみてください！質問もお気軽にどうぞ～',
    packCount: 4,
    totalSales: 380000,
    followerCount: 23100,
    sparksConsumed: {
  ...
  },
  {
    ...
    streamDescription: 'まったり雑談配信☕\n\n今日も気楽にお話ししましょう～\nテーマは特に決めてないので、チャットで話したいことあれば教えてください！\n\nリラックスして楽しんでいってね😊',
    packCount: 2,
    totalSales: 150000,
    followerCount: 8600,
    sparksConsumed: {
  ...
  },
  {
    ...
    isLive: true,
    streamUrl: 'https://player.twitch.tv/?channel=theprimeagen&parent=localhost',
    streamDescription: 'プログラミング初心者向けライブコーディング💻\n\n今日の内容：\n・JavaScriptの基本文法\n・変数と関数の使い方\n・簡単なWebアプリを作ってみよう\n\nコードを書きながら解説します。質問大歓迎！一緒に学んでいきましょう🚀',
    packCount: 3,
    totalSales: 220000,
    followerCount: 14800,
    sparksConsumed: {
