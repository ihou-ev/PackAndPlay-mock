  ...
  if (isLoggedIn()) {
    ...
    if (role === 'creator') {
      ...
      navLinks.innerHTML = `
        ...
        <li><a href="${getRelativePath('dashboard/settings.html')}">配信設定</a></li>
        <li>
...
function renderSidebarNav(currentPage = '') {
  ...
  if (isLoggedIn()) {
    ...
    if (role === 'creator') {
      navHTML = `
        <a href="${getRelativePath('dashboard/index.html')}" class="sidebar-nav-link${currentPage === 'dashboard' ? ' active' : ''}">
        ...
        <a href="${getRelativePath('dashboard/cards.html')}" class="sidebar-nav-link${currentPage === 'dashboard-cards' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01"></path>
          </svg>
          カード管理
        </a>
        <a href="${getRelativePath('dashboard/packs.html')}" class="sidebar-nav-link${currentPage === 'dashboard-packs' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path>
          </svg>
          パック管理
        </a>
        <a href="${getRelativePath('dashboard/redemptions.html')}" class="sidebar-nav-link${currentPage === 'dashboard-redemptions' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          </svg>
          カード承認
        </a>
        <a href="${getRelativePath('dashboard/settings.html')}" class="sidebar-nav-link${currentPage === 'dashboard-settings' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
          </svg>
          配信設定
        </a>
        <a href="${getRelativePath('dashboard/profile.html')}" class="sidebar-nav-link${currentPage === 'dashboard-profile' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
          </svg>
          ホーム設定
        </a>
        <a href="${getRelativePath('settings.html')}" class="sidebar-nav-link${currentPage === 'settings' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      navHTML = `
        <a href="${getRelativePath('profile.html')}" class="sidebar-nav-link${currentPage === 'profile' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="${getRelativePath('inventory.html')}" class="sidebar-nav-link${currentPage === 'inventory' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
          </svg>
          マイカード
        </a>
        <a href="${getRelativePath('history.html')}" class="sidebar-nav-link${currentPage === 'history' ? ' active' : ''}">
          <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    navHTML = `
      <a href="${getRelativePath('login.html')}" class="sidebar-nav-link">
        <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
